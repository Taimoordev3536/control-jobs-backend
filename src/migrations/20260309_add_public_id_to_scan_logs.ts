...
/**
 * Migration: Add public_id (UUID) to scan_logs table.
 *
 * Part of UUID migration Phase 6 — Operational entities.
 * ScanLog is returned in scan history API responses and exposes internal IDs.
 *
 ...
 */
export class AddPublicIdToScanLogs20260309 implements MigrationInterface {
  name = 'AddPublicIdToScanLogs20260309';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE EXTENSION IF NOT EXISTS "uuid-ossp"`);

    const table = 'scan_logs';
