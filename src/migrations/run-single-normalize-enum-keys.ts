...
import { NormalizeEnumKeys20260427 } from './20260427_normalize_enum_keys';
...
async function run() {
  ...
  try {
    const migration = new NormalizeEnumKeys20260427();
    console.log('Applying: NormalizeEnumKeys20260427');
