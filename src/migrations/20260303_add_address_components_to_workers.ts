...
export class AddAddressComponentsToWorkers20260303 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    // Add address component columns to workers table
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    // Remove address component columns from workers table
    await queryRunner.query(`
      ALTER TABLE workers 
