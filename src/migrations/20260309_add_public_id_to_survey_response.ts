...
/**
 * Migration: Add public_id (UUID) to survey_response table.
 *
 * Part of UUID migration Phase 6 — Operational entities.
 * SurveyResponse is returned in survey API responses.
 *
 ...
 */
export class AddPublicIdToSurveyResponse20260309 implements MigrationInterface {
  name = 'AddPublicIdToSurveyResponse20260309';
