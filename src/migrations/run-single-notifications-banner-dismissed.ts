...
import { NotificationsBannerDismissed20260605 } from './20260605c_notifications_banner_dismissed';
...
async function run() {
  ...
  try {
    await new NotificationsBannerDismissed20260605().up(queryRunner);
    console.log('✅ Done');
  } catch (err) {
