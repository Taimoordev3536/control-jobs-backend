...
export class AddAddressComponentsToEmployers20260305 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    // Add address component columns to cjobs_empleadores table
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    // Remove address component columns from cjobs_empleadores table
    await queryRunner.query(`
      ALTER TABLE cjobs_empleadores 
