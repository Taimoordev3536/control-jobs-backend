...
import { CreateAdminUsersTable20260416 } from './20260416_create_admin_users_table';
...
async function run() {
  ...
  try {
    const migration = new CreateAdminUsersTable20260416();
    console.log('Applying: CreateAdminUsersTable20260416');
