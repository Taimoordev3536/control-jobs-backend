...
export class AddAddressComponentsToClients20260302 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    // Add address component columns to clients table
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    // Remove address component columns from clients table
    await queryRunner.query(`
      ALTER TABLE clients 
