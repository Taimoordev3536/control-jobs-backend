...
import { AddSubUsersPermissions20260415 } from './20260415_add_sub_users_permissions';
...
async function run() {
  ...
  try {
    const migration = new AddSubUsersPermissions20260415();
    console.log('Applying: AddSubUsersPermissions20260415');
