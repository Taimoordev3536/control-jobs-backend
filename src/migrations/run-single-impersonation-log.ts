...
import { CreateImpersonationLogTable20260416 } from './20260416_create_impersonation_log_table';
...
async function run() {
  ...
  try {
    const migration = new CreateImpersonationLogTable20260416();
    console.log('Applying: CreateImpersonationLogTable20260416');
